                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group row ml-3">
                            <label for="nomAlertant" class="col-sm-6 col-form-label ml-5">Filtrar pel nom<br><h7 style="font-size: 11px">(si filtres pel nom els altres filtres no es podràn aplicar)</h7></label>
