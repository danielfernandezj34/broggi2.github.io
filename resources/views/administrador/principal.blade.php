...
<div id="botodiv_administrador" class="float-sm-left col-md-4 col-sm-12">
    <a href="./usuaris"><button id="boto_administrador" type="button" class="btn btn-primary ml-lg-5" ><strong>Usuaris i rols</strong></button></a>
</div>
<div id="botodiv_administrador" class="float-sm-left col-md-4 col-sm-12">
...
<div id="botodiv_administrador" class="float-sm-left col-md-4 col-sm-12">
    <button id="boto_administrador" type="button" class="btn btn-outline-danger ml-lg-5" ><strong>Helpbox</strong></button>
</div>
<div id="botodiv_administrador" class="float-sm-left col-md-4 col-sm-12">
    <button id="boto_administrador" type="button" class="btn btn-outline-info" ><strong>Incidències</strong></button>
</div>
<div id="botodiv_administrador" class="float-sm-left col-md-4 col-sm-12">
    <button id="boto_administrador" type="button" class="btn btn-outline-dark mr-lg-5" ><strong>Estadistiques</strong></button>
